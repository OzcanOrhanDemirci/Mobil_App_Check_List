...
const UI_STRINGS = {
  ...
  "proj.add.confirmKept": { tr: "<strong>{currentName}</strong> projendeki tüm verisi (işaretler, notlar, ayarlar) <strong>kayıtlı kalır</strong>.", en: "All data in <strong>{currentName}</strong> (marks, notes, settings) <strong>stays saved</strong>." },
  ...
  "reset.scope.system.desc": { tr: "Her şey silinir: işaretler, notlar, ayarlar, dil, framework. Uygulama ilk açılıştaki gibi başlar (karşılama akışı tekrar gelir).", en: "Everything is wiped: marks, notes, settings, language, framework. The app starts like first launch (welcome flow appears again)." },
