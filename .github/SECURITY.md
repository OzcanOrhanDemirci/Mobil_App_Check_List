...
Security fixes are issued for the current `1.3.x` line. Earlier `1.2.x`,
`1.1.x` and `1.0.x` lines are no longer maintained; please update to the
latest `1.3.x` release before reporting a vulnerability. The current version
is tracked in
